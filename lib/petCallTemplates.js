...
import { PhoneCall, MoonStar, Utensils, Pill, Heart, Gift, Brain, Footprints, HeartPulse } from "lucide-react";
...
export const CALL_TYPES = [
  ...
  {
    id: "walk", label: "遛弯提醒", sub: "遛弯时间到啦",
    Icon: Footprints, tint: "#5FA766",
    flow: [
      "主人，快到我们遛弯时间啦，要不要准备出门？",
      "我已经准备好啦，尾巴都在摇个不停～",
      "走吧走吧，外面的风和草地都在等我们呢 🌿",
    ],
  },
  {
    id: "sick_care", label: "生病照护", sub: "需要你多照顾",
    Icon: HeartPulse, tint: "#E0796F",
    flow: [
      "主人，我今天还需要你多照顾一下哦。",
      "记得按时给我吃药、多陪陪我，我会快点好起来的。",
      "有你在我就安心啦，谢谢你这么爱我 🧡",
    ],
  },
];
...
export const CALL_SCENES = [
  ...
  { id: "walk",            label: "遛弯提醒",    desc: "到了常用遛弯时间，提醒你带它出门",        Icon: Footprints },
  { id: "sick_care",       label: "生病照护",    desc: "生病期间，每天提醒你多照顾它",            Icon: HeartPulse },
...
/* 场景开关默认值（新用户全部开启）。情绪陪伴第一版无法自动触发，暂不作为开关。 */
export const DEFAULT_SCENES = {
  feeding: true, medication: true, walk: true, sick_care: true,
  memory_followup: true, sleep: true, anniversary: true, miss_you: true,
};
