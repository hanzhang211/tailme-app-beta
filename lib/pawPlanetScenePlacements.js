...
export const PAW_PLANET_SCENE_PLACEMENTS = {
  album: {
    ...
    // 右侧、横向中线，放大
    petPlacement: { x: "80%", y: "50%", scale: "24%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  anniversary: {
    ...
    petPlacement: { x: "64%", y: "62%", scale: "25%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  friends: {
    sceneKey: "friends",
    title: "交朋友",
    ...
    // 夹在两只狗中间，上移放大
    petPlacement: { x: "49%", y: "53%", scale: "25%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  mailbox: {
    sceneKey: "mailbox",
    title: "星球信箱",
    ...
    petPlacement: { x: "60%", y: "62%", scale: "25%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  play_ball: {
    sceneKey: "play_ball",
    title: "玩小球",
    ...
    // 移到中间，放大
    petPlacement: { x: "50%", y: "58%", scale: "28%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  sleep_home: {
    sceneKey: "sleep_home",
    title: "小屋睡觉",
    ...
    // 大小不变，略左移
    petPlacement: { x: "60%", y: "62%", scale: "22%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  snack: {
    sceneKey: "snack",
    title: "吃零食",
    ...
    // 略上移，放大
    petPlacement: { x: "64%", y: "54%", scale: "27%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  sunshine: {
    sceneKey: "sunshine",
    title: "晒太阳",
    ...
    // 位置不变，放大
    petPlacement: { x: "50%", y: "58%", scale: "30%", translateX: 0, translateY: 0, zIndex: 2 },
  },
};
