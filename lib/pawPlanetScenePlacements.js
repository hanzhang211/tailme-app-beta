...
export const PAW_PLANET_SCENE_PLACEMENTS = {
  album: {
    ...
    // 画面是照片墙、较满 → 宠物放右侧空处
    petPlacement: { x: "80%", y: "62%", scale: "20%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  anniversary: {
    ...
    // 蛋糕/礼物在左中 → 宠物紧挨右侧像一起庆祝
    petPlacement: { x: "58%", y: "62%", scale: "22%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  friends: {
    sceneKey: "friends",
    title: "交朋友",
    ...
    // 画面已有两只狗 → 宠物夹在两只中间
    petPlacement: { x: "49%", y: "59%", scale: "22%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  mailbox: {
    sceneKey: "mailbox",
    title: "星球信箱",
    ...
    // 信箱/信封在左 → 宠物靠右一点像收到来信
    petPlacement: { x: "54%", y: "62%", scale: "22%", translateX: 0, translateY: 0, zIndex: 2 },
  },
  play_ball: {
    sceneKey: "play_ball",
    title: "玩小球",
